...
MOCK_MODULES = [
    'colorama', 'prettytable', 'numpy' 'pandas'
]
...
project = test_docs_2022.__title__

# Автор(ы) проекта
author = test_docs_2022.__author__en__

# Авторские права
copyright = test_docs_2022.__copyright__

# Версия проекта
version = test_docs_2022.__version__
release = test_docs_2022.__release__
...
github_repository = 'test_docs_2022'
...
latex_documents = [
  ('index', 'PDF.tex', u'PDF', u'TestDocs', 'manual'),
]
