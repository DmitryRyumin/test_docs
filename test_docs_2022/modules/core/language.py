...
#        Tools/i18n/pygettext.py -d test_docs_2022 -o test_docs_2022/modules/locales/base.pot test_docs_2022
#     4. msgfmt --help
#     5. locate msgfmt.py
#     6. /usr/local/Cellar/python@3.9/3.9.13_4/Frameworks/Python.framework/Versions/3.9/share/doc/python3.9/examples/
#        Tools/i18n/msgfmt.py test_docs_2022/modules/locales/en/LC_MESSAGES/base.po test_docs_2022/modules/locales/en/
#        LC_MESSAGES/base
